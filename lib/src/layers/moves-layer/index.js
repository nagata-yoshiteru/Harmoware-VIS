    ...
    MovesLayer.prototype.renderLayers = function () {
        ...
        return [
            ...
            optionVisible ?
                new ArcLayer({
                    id: id + '-moves-opt-arc',
                    data: movedData.filter(function (data) { return data.sourcePosition; }),
                    visible: optionVisible,
                    pickable: true,
                    widthUnits: 'meters',
                    widthMinPixels: 0.1,
